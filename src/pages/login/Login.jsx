...
import { loginWithGoogle, loginWithFacebook, loginWithEmail, getUserRole } from '../../firebase';
...
const Login = () => {
    ...
    const handleLoginSuccess = async (user) => {
        // Check for custom claims/roles if needed
        const claims = await getUserRole(user);
        console.log("User roles:", claims);
            ...
            <div className="max-w-md w-full space-y-8">
                <div>
                    <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
                        Sign in to ClearComment
                    </h2>
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Manage and moderate your community effectively
                    </p>
                </div>
